...
SimpleNavigation::Configuration.run do |navigation|
  navigation.items do |primary|
    ...
    primary.item :the_caffa_store, "#{image_tag 'img-the-caffa-store.png', alt: t('nav.header.the_caffa_store.the_caffa_store')}".html_safe + "#{t('nav.header.the_caffa_store.the_caffa_store')}", 'https://caffaonline.com/', :link => {:target => '_blank'}
  end
end
