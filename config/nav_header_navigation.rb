...
SimpleNavigation::Configuration.run do |navigation|
  navigation.items do |primary|
    primary.item :coffee_event, "#{image_tag 'img-coffee-event.png', alt: t('nav.header.coffee_event.coffee_event')}".html_safe + "#{t('nav.header.coffee_event.coffee_event')}", '#' do |coffee_event|
      ...
      coffee_event.item :program, t('nav.header.coffee_event.program'), page_url(id: 'coffee-event-program')
      coffee_event.item :sponsors, t('nav.header.coffee_event.sponsors'), page_url(id: 'coffee-event-sponsors')
      coffee_event.item :photo_log, t('nav.header.coffee_event.photo_log'), page_url(id: 'coffee-event-photo-log')
    end
